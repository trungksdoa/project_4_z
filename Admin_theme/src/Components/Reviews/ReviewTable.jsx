...
const Review_Table = (props) => {
    const { reviews, onChange, onDelete, onChangeALl } = props;
                    ...
                    return (
                        <tr key={index}>
                            ...
                            <td>
                                <div className="d-flex px-2 py-1">
                                    <div className="d-flex flex-column justify-content-center">
                                        <h6 className="mb-0 text-sm">{review.user_id}</h6>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div className="d-flex px-2 py-1">
                                    <div className="d-flex flex-column justify-content-center">
                                        <h6 className="mb-0 text-sm">{review.book_id}</h6>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td className="align-middle text-center">
                                <span className="text-secondary text-xs font-weight-bold">5</span>
                            </td>
                            <td className="align-middle text-center">
