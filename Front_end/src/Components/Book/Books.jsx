...
const Book = ({
	...
	async function fetchData() {
		if (auth) {
			await WishlistAPI.getByBookId(cookies.loggin.userID, booksid)
				.then((wishlist) => {
		...
		<div className="col-xs-6 col-sm-6 col-md-4 col-lg-3">
			<div className="tg-postbook">
				<figure className="tg-featureimg">
					<div className="tg-bookimg">
						<div className="tg-frontcover">
							<img
								src={'http://localhost:9999/image/' + pdetailid.imageLink + '?v' + new Date().getTime()}
				...
				<div className="tg-postbookcontent">
					<ul className="tg-bookscategories">
						<li>
							<a href="javascript:void(0);">Art &amp; Photography</a>
						</li>
					</ul>
					<div className="tg-themetagbox">
						<span className="tg-themetag">sale</span>
